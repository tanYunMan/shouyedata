<template>
  <div class="container menu6-1-container">
    <div class="filter-wrap">
      <el-button type="primary" @click="addLevel(null)">新增域名</el-button>
    </div>
    <el-table border row-key="id" ref="multipleTable" :data="tableData" style="width: 100%" @selection-change="handleSelectionChange" :header-cell-style="{background:'#f5f5f5',color:'#606266'}" >
       <el-table-column :show-overflow-tooltip="true" prop="domainID" label="编号"  ></el-table-column>
       <el-table-column :show-overflow-tooltip="true" prop="domainAddr" label="域名地址"></el-table-column>
...
import { getSiteList,goSetLevel,delConfirmLevel } from '@/api/platform/net/index'
export default {
  data() {
    return {
      color:'#333',
