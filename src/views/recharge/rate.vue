<template>
  <div class="app-container container">
      <el-form ref="form" :model="form" :rules="rules">
        ...
        <el-form-item>
          <el-button size="small" style="margin-left:120px;" type="primary" @click="saveRate('form')" :loading="loading">立即保存</el-button>
        </el-form-item>
      </el-form>
  </div>
</template>
...
export default {
    ...
    methods:{
        _rate() {
            getDatas({},'/finance/rechargeRate/get').then(res => {
        ...
        saveRate(formName) {
            this.$refs[formName].validate((valid) => {
                ...
                this.loading = true
                getLists({...this.form},'/finance/rechargeRate/add').then(res => {
                    if (res.code==1001){
                        this.$message({
                            message: '操作成功！',
                            type: 'success'
