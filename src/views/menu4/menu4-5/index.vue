  ...
  <div class="container menu2-1-container">
    <div class="filter-wrap">
      ...
      <el-select @change="onTypeChange" v-model="form.type" placeholder="请选择查询类型">
        <el-option label="站点名称" value="2"></el-option>
        <el-option label="对接码" value="3"></el-option>
        <el-option label="商品名称" value="1"></el-option>
      </el-select>
      <el-input v-model="form.goodsName" placeholder="请输入关键字" style="width:200px;"></el-input>
      <el-button type="primary" icon="el-icon-search"   @click="queryList">查询</el-button>
      <el-button type="primary" icon="el-icon-share" style="margin:10px 10px 0 0" @click="batchDocking">批量对接</el-button>
    </div>
    <div>
...
//
    ...
    queryList(){
      ...
      if (this.form.type === '1') {// 商品名称查询
          this.queryParams = { ...this.queryParams,goodsName:this.form.goodsName}
      }
