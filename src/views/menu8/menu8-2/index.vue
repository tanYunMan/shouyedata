<template>
  <div class="container menu8-1-container">
    ...
    <el-table border row-key="id" ref="multipleTable" :data="tableData" style="width: 100%" @selection-change="handleSelectionChange" :header-cell-style="{background:'#f5f5f5',color:'#606266'}" >
       <el-table-column :show-overflow-tooltip="true" prop="orderCode" label="订单号"  width="180"></el-table-column>
       ...
       <el-table-column :show-overflow-tooltip="true" prop="supplierName" label="供应商" width="150"></el-table-column>
       <el-table-column :show-overflow-tooltip="true" prop="goodsUserName" label="购买客户" width="200"></el-table-column>
       ...
       <el-table-column :show-overflow-tooltip="true" prop="createTime" label="销售日期" width="150"></el-table-column>
