  ...
  <div>
    ...
    >
     <el-table-column :show-overflow-tooltip="true" type="selection" align="center"></el-table-column>
      ...
      <el-table-column :show-overflow-tooltip="true"  label="成本价" align="center" width="100">
      ...
      <el-table-column :show-overflow-tooltip="true"  label="全网代理" align="center" width="80">
        <template slot-scope="scope">
          <el-switch :active-value='1' :inactive-value='0' @change="updateAgentType(scope.row)" v-model="scope.row.agentType"></el-switch>
        </template>
      </el-table-column>
      <el-table-column :show-overflow-tooltip="true"  label="上下架" align="center" width="80">
        <template slot-scope="scope">
          <el-switch :active-value='1' :inactive-value='0' @change="updateGoodsState(scope.row)" v-model="scope.row.goodsState"></el-switch>
        </template>
      </el-table-column>
      <el-table-column :show-overflow-tooltip="true" label="库存" align="center" width="110">
        <template slot-scope="scope">
      ...
      <el-table-column :show-overflow-tooltip="true" label="卖出" align="center" width="80">
        <template slot-scope="scope">
      ...
      <el-table-column :show-overflow-tooltip="true" prop="updateTime" label="创建时间" align="center" width="150"></el-table-column>
